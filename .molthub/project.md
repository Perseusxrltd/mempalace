...
latest_milestone: "v3.5.3 — Clean user install dependency hardening for Chroma/protobuf compatibility (May 2026)"
---
...
- `plugin.json` + `marketplace.json`: registers Mnemion as a Claude Code plugin (v3.5.3).
...
- `plugin.json`: registers Mnemion as an OpenAI Codex CLI plugin (v3.5.3).
