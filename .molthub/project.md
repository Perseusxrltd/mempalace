...
latest_milestone: "v3.5.2 — Windows console install hardening, version CLI, and new-user smoke proof (May 2026)"
---
...
- `plugin.json` + `marketplace.json`: registers Mnemion as a Claude Code plugin (v3.5.2).
...
- `plugin.json`: registers Mnemion as an OpenAI Codex CLI plugin (v3.5.2).
